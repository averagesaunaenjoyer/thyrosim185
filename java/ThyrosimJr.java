...
public class ThyrosimJr implements FirstOrderDifferentialEquations
{
    ...
    // Declare parameters
    public ThyrosimJr(double dial1, double dial2, double dial3, double dial4,
...
qDot[18] = kdelay*(q[17] -q[18]);                               // delay6
    ...
    public static void main(String[] args)
    {
        ...
        ThyrosimJr ode = new ThyrosimJr(dial1, dial2, dial3, dial4, inf1, inf4);
