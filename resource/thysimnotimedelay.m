...
global p37 p38 p39 p40 p41 p42 p43 p44 p45 p46 p47 p48 u1 u4;
...
q0 = [0.29084565; 0.17812003; 0.56569934; 0.0071879; 0.01203157; 0.08047781; 2.42113484; 6.24768772; 6.5; 0; 0; 0; 0];  % ICs (Note: s0 = e0)
tspan = [0 240];
...
%vopt = odeset ('NormControl','on','InitialStep',1e-3,'MaxStep',1e-3);
