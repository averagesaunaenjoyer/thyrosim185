...
% Using the SS above to 24 hours without additional input
%q0 = [0.34060; 0.21676; 0.68261; 0.0061601; 0.010525; 0.066670; 1.8852; 7.0045; 7.0042; 0; 0; 0; 0; 3.5227; 3.8895; 4.0840; 4.1045; 3.9750; 3.7374];  % ICs (Note: s0 = e0)
% Using Marisa's 2nd IC and running to 1000 hours, with 600 mcg T4
%q0 = [0.34259; 0.21927; 0.69417; 0.0058624; 0.010055; 0.066915; 2.6825; 7.0418; 7.0443; 0.7722; 0; 0; 0; 3.9020; 3.4495; 3.0095; 2.6449; 2.3987; 2.2906];  % ICs (Note: s0 = e0)
% 50% SR
%q0 = [0.30381; 0.18857; 0.59588; 0.0055668; 0.0093571; 0.062933; 4.7438; 6.4728; 6.4750; 0; 0; 0.061444; 0; 6.9016; 6.1011; 5.3217; 4.6749; 4.2376; 4.0444];  % ICs (Note: s0 = e0)
...
vopt = odeset ('RelTol',1e-2,'AbsTol',1e-2,'InitialStep',10,'MaxStep',100);
